...
export default function instrumentBullRedisQueueSystem(shim, bullTransport) {
  shim.setLibrary('stellarjs');

  shim.recordProduce(bullTransport.BullRedisQueueSystem.prototype, 'enqueue', (_shim, fn, name, args) => {
